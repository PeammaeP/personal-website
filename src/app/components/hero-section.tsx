    ...
    <section>
      <div className="grid grid-col-1 sm:grid-cols-12">
        ...
        <div className="col-span-7 place-content-center text-center sm:text-left ">
          <h1 className="hover:-translate-y-2 grid font-bold mb-4 text-5xl">
          ...
          <p className="font-semibold text-white text-lg text-left">
          ...
          <div className="sm:mt-6 mt-5 lg:mt-4">
            <button className="px-5 py-4 w-full sm:w-fit font-bold rounded-full bg-transparent text-black hover:bg-[#edeaea] mr-5 mt-3 hover:-translate-y-2 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500">
              Github Pages
            </button>
            <button className="px-1 py-1 w-full sm:w-fit font-bold rounded-full hover:bg-[#1f1e1e] mt-5 hover:-translate-y-2 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500">
              <span className="block bg-[#080808] rounded-full hover:bg-slate-800 px-5 py-3">
                Download CV
              </span>
            </button>
          </div>
